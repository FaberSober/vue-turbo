...
export function getNearestColorPaletteFamily(color: string, families: ColorPaletteFamily[]): ColorPaletteFamilyWithNearestPalette {
...
export function getColorPaletteFamily(color: string, colorName: string): ColorPaletteFamily {
  ...
  const { nearestLightnessPalette, palettes } = getNearestColorPaletteFamily(color, defaultPalettes as ColorPaletteFamily[]);
