...
declare namespace UnionKey {
   ...
   */
  // type ThemeScrollMode = import('@fa/materials').LayoutScrollMode;
  type ThemeScrollMode = any;
   ...
   * - button: button style
   */
  // type ThemeTabMode = import('@fa/materials').PageTabMode;
  type ThemeTabMode = any;
