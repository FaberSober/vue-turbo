...
import { themePageAnimationModeOptions, themeScrollModeOptions, themeTabModeOptions } from '@f/admin/constants/app';
import { translateOptions } from '@f/admin/utils/common';
